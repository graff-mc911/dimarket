...
export function Contact() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Зберігаємо звернення в таблицю feedback_messages,
      // щоб воно одразу зʼявилося в owner-кабінеті.
      ...
      setFeedback({
        type: 'success',
        text: 'Повідомлення успішно відправлено. Воно вже зʼявилося в особистому кабінеті власника сайту.',
      })
