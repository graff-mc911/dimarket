                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 max-h-96 overflow-auto z-50 border border-gray-100">
                  {LANGUAGES.map((lang) => (
                    <button
                      ...
                      className={`block w-full text-left px-4 py-3 text-sm font-medium transition rounded-lg mx-2 ${
                        language.code === lang.code ? 'bg-gradient-to-r from-primary to-secondary text-white shadow-md' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'
                      }`}
                    >
                      {lang.name}
                    </button>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 z-50 border border-gray-100">
                  {CURRENCIES.map((curr) => (
                    <button
                      ...
                      className={`block w-full text-left px-4 py-3 text-sm font-medium transition rounded-lg mx-2 ${
                        currency.code === curr.code ? 'bg-gradient-to-r from-primary to-secondary text-white shadow-md' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'
                      }`}
                    >
            ...
            {user && profile ? (
              <div className="relative group">
                ...
                <div className="hidden group-hover:block absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 z-50 border border-gray-100">
                  <a href="/profile" className="block px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition rounded-lg mx-2">
                    {t('header.myProfile')}
                  </a>
                  {profile.is_professional && (
                    <>
                      <a href="/dashboard" className="block px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition rounded-lg mx-2">
                        {t('header.dashboard')}
                      </a>
                      <a href="/my-listings" className="block px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition rounded-lg mx-2">
                        {t('header.myListings')}
                      </a>
                    </>
                  )}
                  ...
                  <button
                    onClick={signOut}
                    className="flex items-center space-x-2 w-full px-4 py-3 text-sm font-medium text-red-600 hover:bg-red-50 transition rounded-lg mx-2"
                  >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 max-h-[calc(100vh-4rem)] overflow-y-auto">
            ...
            {user && profile ? (
              <>
                <a href="/profile" className="flex items-center space-x-2 px-4 py-3 rounded-lg text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition">
                  <User className="w-5 h-5" />
                  <span>{t('header.myProfile')}</span>
                </a>
                {profile.is_professional && (
                  <>
                    <a href="/dashboard" className="block px-4 py-3 rounded-lg text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition">
                      {t('header.dashboard')}
                    </a>
                    <a href="/my-listings" className="block px-4 py-3 rounded-lg text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition">
                      {t('header.myListings')}
                    </a>
                  </>
                )}
              ...
              <a href="/login" className="block px-4 py-3 rounded-lg text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition">
                {t('header.professionalLogin')}
              </a>
            )}
            <a
              href="/create-ad"
              className="block mx-3 my-2 px-4 py-3 rounded-lg text-base font-semibold bg-gradient-to-r from-primary to-secondary text-white hover:shadow-lg transition-all duration-300 text-center"
            >
              {t('header.createAd')}
            </a>
          </div>
